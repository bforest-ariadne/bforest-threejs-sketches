...
//    this.rotating=false;
    ...
    this.handleEvents = opts.handleEvents !== 'undefined' ? opts.handleEvents : false;
...
/*    
  ...
  */  
    ...
    function handleMouseDownRotate( event, position ) {
        if ( typeof position !== 'undefined' ) {
            rotateStart.set( position[0], position[1] );
        } else {
    ...
    */
    function handleMouseMoveRotate( event, position ) {

        if ( typeof position !== 'undefined' ) {
            rotateEnd.set( position[0], position[1] );
...
//        console.log(rotateDelta.y, element.clientHeight);
    ...
    function handleTouchStartRotate( event, position ) {
        if ( typeof position !== 'undefined' ) {
            rotateStart.set( position[0], position[1] );
        } else {
    ...
    function handleTouchStartDolly( event, position ) {
...
//        panStart.set( event.touches[ 0 ].pageX, event.touches[ 0 ].pageY );
    ...
    */
    function handleTouchMoveRotate( event, position ) {
...
//            if ( scope.enableRotate === false ) return;
            ...
            handleMouseDownRotate( event, position );
  ...
  //          if ( scope.enableZoom === false ) return;
        ...
        */
        if ( state !== STATE.NONE && this.handleEvents ) {
...
//        if ( scope.enabled === false ) return;
        ...
        if ( state === STATE.ROTATE ) {
            ...
            handleMouseMoveRotate( event, position );
 ...
 */   
    function onTouchStart( event, position ) {
        ...
        switch ( event.touches.length ) {
          ...
          //      if ( scope.enableRotate === false ) return;
                ...
                handleTouchStartRotate( event, position );
    ...
    function onTouchMove( event, position ) {
        ...
        switch ( event.touches.length ) {
            ...
            case 1: // one-fingered touch: rotate
                ...
                handleTouchMoveRotate( event, position );
